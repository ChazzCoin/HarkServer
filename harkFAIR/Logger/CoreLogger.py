...
from harkFAIR.Logger import Futils
from harkFAIR.Logger import LogColors
from harkFAIR.Logger import fig
import os
...
class Log:
    ...
    def create_message(self, *messages):
        temp_message = ""
        for m in messages:
            temp_message = combine_words(temp_message, m)
        return temp_message
